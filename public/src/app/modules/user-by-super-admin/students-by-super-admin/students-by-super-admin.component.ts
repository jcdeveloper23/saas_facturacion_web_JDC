...
@Component({
  selector: 'app-students-by-super-admin',
  templateUrl: './students-by-super-admin.component.html',
  styleUrls: ['./students-by-super-admin.component.css']
})
export class StudentsBySuperAdminComponent implements OnInit {
  ...
  public getStudentsBySchool() {
    this.studentService.getStudentsBySchoolActives(this.provider_school_id).pipe(take(1)).subscribe(students => {
