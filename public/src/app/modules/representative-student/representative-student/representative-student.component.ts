...
export class RepresentativeStudentComponent implements OnInit {
  ...
  public provider_school_id = '1624925372360'
  ...
  ngOnInit(): void {
    ...
    this.parallels = [];
    this.arrayStudents = [];
    this.representative.representative_schools = [];
    this.representative.representative_id = '1624926173297';
    this.representative.representative_schools[0]='1624925372360';
    this.getStudents();
    // this.getLevels();
  }
  /**
  ...
  public async saveStudent(student: Student, isValid: boolean, form: NgForm) {
    ...
    this.student.student_id_school = this.representative.representative_schools[0];
  ...
  */
   ...
   */
  public getStudents() {
    this.studentService.getStudentsByRepresentativeActives(this.representative.representative_id).subscribe(students => {
   ...
   */
  public getLevels() {
    this.levelsService.getLevelsBySchool(this.student.student_id_school).pipe(take(1)).subscribe(levels => {
      this.levels = levels;
    })
  }
