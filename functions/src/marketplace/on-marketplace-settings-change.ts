  ...
  async (event) => {
    ...
    try {
      ...
      await catalogRef.set({
        ...
        phone:            afterMarketplace['phone']            ?? null,
        email:            afterMarketplace['email']            ?? null,
        instagram:        afterMarketplace['instagram']        ?? null,
        facebook:         afterMarketplace['facebook']         ?? null,
        tiktok:           afterMarketplace['tiktok']           ?? null,
        locationText:     afterMarketplace['locationText']     ?? null,
        locationUrl:      afterMarketplace['locationUrl']      ?? null,
